...
namespace WWFramework
{
    ...
    public static class PunycodeUtil
    {
        ...
        public static string Encode(string input)
        {
            ...
            List<int> inputChars = input.ToCharArray().SelectList(c => (int)c);
            List<int> basicChars = inputChars.WhereList(c => c < 0x80);
            List<int> extendedChars = inputChars.ExceptList(basicChars);
            ...
            return new string(output.SelectArray(c => (char)c));
        }
