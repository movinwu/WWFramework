...
namespace WWFramework
{
    ...
    /// 网络连接配置
    /// </summary>
    [CreateAssetMenu(fileName = GlobalEditorStringDefine.NetworkConfigName, menuName = GlobalEditorStringDefine.NetworkConfig, order = GlobalEditorPriorityDefine.NetworkConfig)]
