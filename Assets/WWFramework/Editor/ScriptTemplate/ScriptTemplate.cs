    ...
    public class ScriptTemplate
    {
        ...
        private static void CreateCommonScript()
        {
            ...
            ProjectWindowUtil.CreateScriptAssetFromTemplateFile(
                "Assets/WWFramework/Editor/ScriptTemplate/Templates/CommonScriptTemplate.cs.txt",
                "NewCommonScript.cs");
        }
        ...
        private static void CreateWWFrameworkScript()
        {
            // 调用 Unity 的内置方法创建脚本
            ProjectWindowUtil.CreateScriptAssetFromTemplateFile(
                "Assets/WWFramework/Editor/ScriptTemplate/Templates/WWFrameworkScriptTemplate.cs.txt",
