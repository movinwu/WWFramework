...
namespace WWFramework
{
    public class IDCardUtil
    {
        ...
        /// 校验码集合
        /// </summary>
        private static char[] checksums = { '1', '0', 'X', '9', '8', '7', '6', '5', '4', '3', '2' };
        ...
        public static bool IsValid15(string idcard)
        {
            ...
            DateTime birthday;
            if (!DateTime.TryParseExact(idcard.Substring(6, 6), "yyMMdd", null,
        ...
        public static bool IsValid18(string idcard)
        {
            ...
            DateTime birthday;
            if (!DateTime.TryParseExact(idcard.Substring(6, 8), "yyyyMMdd", null,
                    System.Globalization.DateTimeStyles.None, out birthday))
            {
                return false;
            }
        ...
        public static bool IsValidChecksum(string idcard)
        {
            ...
            var expectedChecksum = checksums[checksumIndex];

            return char.ToUpper(idcard[17]) == expectedChecksum;
        }
        ...
        public static string GenerateRandomIdcard(Gender gender = Gender.Male, int minAge = 18, int maxAge = 65)
        {
            ...
            DateTime birthday = DateTimeUtil.GetRandomDateTime(minBirthday, maxBirthday);
            string area = GetRandomArea();
            var random = new Random();
            int sequence = random.Next(1, 1000);
            int genderCode = gender == Gender.Male ? 1 : 2;
        ...
        {
            var random = new Random();
            int index = random.Next(0, areas.Count);
            int counter = 0;
